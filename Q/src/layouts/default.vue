    ...
    Enter () {
      ...
      switch (this.selectedReport) {
        case 'Report':
          ...
          if (this.reportProps === 'daily') {
            if (this.DailyReport) {
              this.$router.push({name: 'DailyReportProps', params: {selectedDateS: this.selectedDate, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr}})
              ...
              this.$router.push({name: 'IntegratedDailyReport', params: {selectedDateS: this.selectedDate, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr}})
              // console.log('IntegratedDailyReport')
            }
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'PeriodReportWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek}})
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'PeriodReportTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays}})
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'PeriodReportMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth}})
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'PeriodReportQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter}})
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'PeriodReportYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo}})
          } else {
            this.$router.push({name: 'PeriodReport', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo}})
        ...
        case 'ProductionStatisticsTable':
          ...
          if (this.reportProps === 'daily') {
            this.$router.push({name: 'DefectiveTableDaily', params: {selectedDateS: this.selectedDate, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, defectiveGroup: this.productionStatisticsTotal, defectiveTableTimes: this.productionStatisticsSel}})
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'DefectiveTableWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek, defectiveGroup: this.productionStatisticsTotal, defectiveTableTimes: this.productionStatisticsSel}})
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'DefectiveTableTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays, defectiveGroup: this.productionStatisticsTotal, defectiveTableTimes: this.productionStatisticsSel}})
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'DefectiveTableMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth, defectiveGroup: this.productionStatisticsTotal, defectiveTableTimes: this.productionStatisticsSel}})
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'DefectiveTableQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter, defectiveGroup: this.productionStatisticsTotal, defectiveTableTimes: this.productionStatisticsSel}})
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'DefectiveTableYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo, defectiveGroup: this.productionStatisticsTotal, defectiveTableTimes: this.productionStatisticsSel}})
          } else {
            this.$router.push({name: 'DefectiveTable1', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo, defectiveGroup: this.productionStatisticsTotal, defectiveTableTimes: this.productionStatisticsSel}})
          }
          this.page = ''
          // console.log(this.selectedReport)
          break
        case 'Curve':
          ...
          if (this.reportProps === 'daily') {
            this.$router.push({name: 'DefectiveCurveDaily', params: {selectedDateS: this.selectedDate, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, defectiveGroup: this.curveTotal, defectiveTableTimes: this.curveSel}})
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'DefectiveCurveWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek, defectiveGroup: this.curveTotal, defectiveTableTimes: this.curveSel}})
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'DefectiveCurveTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays, defectiveGroup: this.curveTotal, defectiveTableTimes: this.curveSel}})
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'DefectiveCurveMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth, defectiveGroup: this.curveTotal, defectiveTableTimes: this.curveSel}})
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'DefectiveCurveQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter, defectiveGroup: this.curveTotal, defectiveTableTimes: this.curveSel}})
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'DefectiveCurveYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo, defectiveGroup: this.curveTotal, defectiveTableTimes: this.curveSel}})
          } else {
            this.$router.push({name: 'DefectiveCurve1', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo, defectiveGroup: this.curveTotal, defectiveTableTimes: this.curveSel}})
          }
          // this.$router.push({name: 'DefectiveCurve', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, departmentS: this.radio1, yearMonth: this.yearMonth, defectiveTableTimes: this.defectiveTableTimes, defectiveGroup: this.defectiveGroup}})
          this.page = ''
          // console.log(this.selectedReport)
          break
        case 'ProductReport':
          ...
          if (this.reportProps === 'daily') {
            this.$router.push({name: 'ProductPeriodReportDaily', params: {selectedDateS: this.selectedDate, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, ProductReportFrom: this.ProductReportFrom, ProductReportTo: this.ProductReportTo}})
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'ProductPeriodReportWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek, ProductReportFrom: this.ProductReportFrom, ProductReportTo: this.ProductReportTo}})
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'ProductPeriodReportTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays, ProductReportFrom: this.ProductReportFrom, ProductReportTo: this.ProductReportTo}})
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'ProductPeriodReportMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth, ProductReportFrom: this.ProductReportFrom, ProductReportTo: this.ProductReportTo}})
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'ProductPeriodReportQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter, ProductReportFrom: this.ProductReportFrom, ProductReportTo: this.ProductReportTo}})
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'ProductPeriodReportYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo, ProductReportFrom: this.ProductReportFrom, ProductReportTo: this.ProductReportTo}})
          } else {
            this.$router.push({name: 'ProductPeriodReport1', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo, ProductReportFrom: this.ProductReportFrom, ProductReportTo: this.ProductReportTo}})
            // this.$router.push({name: 'PeriodReport', params: {period: this.reportProps, department: this.radio1, zone: this.checked}})
          }
          this.page = ''
          // console.log(this.selectedReport)
        ...
        case 'MoldReport':
          ...
          if (this.reportProps === 'daily') {
            this.$router.push({name: 'MoldPeriodReportDaily', params: {selectedDateS: this.selectedDate, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, MoldReportFrom: this.MoldReportFrom, MoldReportTo: this.MoldReportTo}})
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'MoldPeriodReportWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek, MoldReportFrom: this.MoldReportFrom, MoldReportTo: this.MoldReportTo}})
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'MoldPeriodReportTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays, MoldReportFrom: this.MoldReportFrom, MoldReportTo: this.MoldReportTo}})
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'MoldPeriodReportMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth, MoldReportFrom: this.MoldReportFrom, MoldReportTo: this.MoldReportTo}})
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'MoldPeriodReportQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter, MoldReportFrom: this.MoldReportFrom, MoldReportTo: this.MoldReportTo}})
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'MoldPeriodReportYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo, MoldReportFrom: this.MoldReportFrom, MoldReportTo: this.MoldReportTo}})
          } else {
            this.$router.push({name: 'MoldPeriodReport1', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo, MoldReportFrom: this.MoldReportFrom, MoldReportTo: this.MoldReportTo}})
            // this.$router.push({name: 'PeriodReport', params: {period: this.reportProps, department: this.radio1, zone: this.checked}})
          }
          this.page = ''
          // console.log(this.selectedReport)
        ...
        case 'MOQ':
          ...
          if (this.reportProps === 'daily') {
            ...
            this.$router.push({name: 'MOQAnalysisDaily', params: {period: this.reportProps, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDateS: this.selectedDate}})
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'MOQAnalysisWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek}})
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'MOQAnalysisTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays}})
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'MOQAnalysisMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth}})
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'MOQAnalysisQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter}})
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'MOQAnalysisYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo}})
          } else {
            this.$router.push({name: 'MOQAnalysis1', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo}})
          }
          this.page = ''
          // console.log(this.selectedReport)
          break
        case 'ProductProcessAnalysis':
          ...
          if (this.reportProps === 'daily') {
            this.$router.push({name: 'ProcessAnalysisReportDaily', params: {selectedDateS: this.selectedDate, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, Sel: this.ProductArrSel}})
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'ProcessAnalysisReportWeekly', params: {reportType: 'productAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek, Sel: this.ProductArrSel}})
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'ProcessAnalysisReportTenDays', params: {reportType: 'productAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays, Sel: this.ProductArrSel}})
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'ProcessAnalysisReportMonthly', params: {reportType: 'productAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth, Sel: this.ProductArrSel}})
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'ProcessAnalysisReportQuarterly', params: {reportType: 'productAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter, Sel: this.ProductArrSel}})
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'ProcessAnalysisReportYearly', params: {reportType: 'productAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo, Sel: this.ProductArrSel}})
          } else {
            this.$router.push({name: 'ProcessAnalysisReport1', params: {reportType: 'productAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo, Sel: this.ProductArrSel}})
            // this.$router.push({name: 'PeriodReport', params: {period: this.reportProps, department: this.radio1, zone: this.checked}})
          }
          this.page = ''
          // console.log(this.selectedReport)
        ...
        case 'MoldNumProcessAnalysis':
          ...
          if (this.reportProps === 'daily') {
            this.$router.push({name: 'ProcessAnalysisReportDaily', params: {selectedDateS: this.selectedDate, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, Sel: this.MoldArrSel}})
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'ProcessAnalysisReportWeekly', params: {reportType: 'MoldNumAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek, Sel: this.MoldArrSel}})
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'ProcessAnalysisReportTenDays', params: {reportType: 'MoldNumAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays, Sel: this.MoldArrSel}})
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'ProcessAnalysisReportMonthly', params: {reportType: 'MoldNumAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth, Sel: this.MoldArrSel}})
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'ProcessAnalysisReportQuarterly', params: {reportType: 'MoldNumAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter, Sel: this.MoldArrSel}})
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'ProcessAnalysisReportYearly', params: {reportType: 'MoldNumAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo, Sel: this.MoldArrSel}})
          } else {
            this.$router.push({name: 'ProcessAnalysisReport1', params: {reportType: 'MoldNumAnalysis', period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo, Sel: this.MoldArrSel}})
            // this.$router.push({name: 'PeriodReport', params: {period: this.reportProps, department: this.radio1, zone: this.checked}})
          }
          this.page = ''
          // console.log(this.selectedReport)
      ...
      switch (this.selectedReport) {
        ...
        case 'Utilization':
          ...
          if (this.reportProps === 'daily') {
            ...
            this.$router.push({name: 'UtilizationDaily', params: {period: this.reportProps, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDateS: this.selectedDate}})
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'UtilizationWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek}})
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'UtilizationTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays}})
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'UtilizationMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth}})
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'UtilizationQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter}})
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'UtilizationYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo}})
          } else {
            this.$router.push({name: 'Utilization1', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo}})
          }
          this.page = ''
          break
        case 'MOQ':
      ...
      switch (this.selectedAlmReport) {
        case 'AbnormalTable':
          ...
          if (this.reportProps === 'daily') {
            ...
            this.$router.push({name: 'AbnormalTableDaily', params: {period: this.reportProps, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDateS: this.selectedDate, abnormaleTableTimes: this.abnormaleTableTimes}})
            this.page = ''
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'AbnormalTableWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek, abnormaleTableTimes: this.abnormaleTableTimes}})
            this.page = ''
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'AbnormalTableTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays, abnormaleTableTimes: this.abnormaleTableTimes}})
            this.page = ''
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'AbnormalTableMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth, abnormaleTableTimes: this.abnormaleTableTimes}})
            this.page = ''
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'AbnormalTableQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter, abnormaleTableTimes: this.abnormaleTableTimes}})
            this.page = ''
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'AbnormalTableYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo, abnormaleTableTimes: this.abnormaleTableTimes}})
            this.page = ''
          } else {
            this.$router.push({name: 'AbnormalTable1', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo, abnormaleTableTimes: this.abnormaleTableTimes}})
            this.page = ''
          }
          this.page = ''
        ...
        case 'AbnormalPie':
          ...
          if (this.reportProps === 'daily') {
            ...
            this.$router.push({name: 'AbnormalPieDaily', params: {period: this.reportProps, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDateS: this.selectedDate, group: this.abnormalePieGroup, orgArr: this.orgArr}})
            this.page = ''
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'AbnormalPieWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek, group: this.abnormalePieGroup, orgArr: this.orgArr}})
            this.page = ''
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'AbnormalPieTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays, group: this.abnormalePieGroup, orgArr: this.orgArr}})
            this.page = ''
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'AbnormalPieMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth, group: this.abnormalePieGroup, orgArr: Object.assign({}, this.orgArr)}})
            this.page = ''
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'AbnormalPieQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter, group: this.abnormalePieGroup, orgArr: this.orgArr}})
            this.page = ''
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'AbnormalPieYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo, group: this.abnormalePieGroup, orgArr: this.orgArr}})
            this.page = ''
          } else {
            this.$router.push({name: 'AbnormalPie1', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo, group: this.abnormalePieGroup, orgArr: this.orgArr}})
            this.page = ''
          }
          this.page = ''
        ...
        case 'Abnormal':
          ...
          if (this.reportProps === 'daily') {
            ...
            this.$router.push({name: 'AbnormalReportDaily', params: {period: this.reportProps, departmentS: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDateS: this.selectedDate}})
            this.page = ''
          } else if (this.reportProps === 'weekly') {
            this.$router.push({name: 'AbnormalReportWeekly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearWeekly: this.selectedYearWeekly, selectedWeek: this.selectedWeek}})
            this.page = ''
          } else if (this.reportProps === 'tenDays') {
            this.$router.push({name: 'AbnormalReportTenDays', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonthTenDays: this.yearMonthTenDays, selectedTenDays: this.selectedTenDays}})
            this.page = ''
          } else if (this.reportProps === 'monthly') {
            this.$router.push({name: 'AbnormalReportMonthly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, yearMonth: this.yearMonth}})
            this.page = ''
          } else if (this.reportProps === 'quarterly') {
            this.$router.push({name: 'AbnormalReportQuarterly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYearQuarter: this.selectedYearQuarter, selectedQuarter: this.selectedQuarter}})
            this.page = ''
          } else if (this.reportProps === 'yearly') {
            this.$router.push({name: 'AbnormalReportYearly', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedYear: this.selectedYear, selectedYearTo: this.selectedYearTo}})
            this.page = ''
          } else {
            this.$router.push({name: 'AbnormalReport1', params: {period: this.reportProps, department: this.radio1, zoneS: zoneS, checked: checkedToStr, selectedDatePeriod: this.selectedDatePeriod, selectedDatePeriodTo: this.selectedDatePeriodTo}})
            this.page = ''
          }
          this.page = ''
