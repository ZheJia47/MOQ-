...
<section class="content">
  ...
  <!-- dropdown content -->
      ...
      <q-btn outline glossy label='EXCEL匯出' icon="icon-svg57" @click="ExcelExport(rows, columns, machineID + '警報紀錄')"/>
    ...
    <!--<q-list>-->
     ...
     <div class="col q-pt-xs q-pb-xs">
      <h1 v-if="status === null">射出機警報資料明細
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      自{{from}}~{{to}}</h1>
      <h1 v-else>射出機警報資料明細 ({{status}})
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      自{{from}}~{{to}}</h1>
   </div>
      <!--</q-item>-->
...
function renderTable (rows, machineID, iReportDate, selectedDateTo, orderNumberList, noteListArr, rowArray) {
  ...
  $.get('/api/getMachineAlarmRecords/' + machineID + '/' + reportDate + '/' + reportDateTo, {}, (results) => {
    if (results.type !== true) {
      alert(`response is not correct, err: ${results.data}`)
      ...
      records.forEach(record => {
        let tempMoldArray = []
        /* if (record['orderNumber'] !== '1911190060') {
          return
        } */
