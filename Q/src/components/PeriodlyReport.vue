    ...
    <div class="row center-block">
      ...
      <div class="col-md-12">
        部門: <select v-model="departmentID">
          <option v-for="department in departmentList" v-bind:value="department">
          {{ department }}
          </option>
        </select>
      </div>
      <div v-if="period === 'weekly'">
        <div class="col-lg-6 col-sm-12">
          年份: <select v-model="selectedYear"> 
            <option v-for="year in range(2017, 2020)" v-bind:value="year"> {{year}}</option>
          </select>
          週數: <select v-model="selectedWeek"> 
            <option v-for="week in weeksInYear" v-bind:value="week"> {{week}}</option>
          </select>
          {{dateFrom}} ~ {{dateTo}}
        </div>
      </div>
      <div v-else-if="period === 'tenDays'">
        <div class="col-lg-6 col-sm-12">
          選擇月份: 
          <input type="month" name="yearMonth" v-model="yearMonth"></input>
        </div>
        <div class="col-lg-6 col-sm-12">
      ...
      <div v-else-if="period === 'monthly'">
        <div class="col-lg-6 col-sm-12">
          選擇月份: 
          <input type="month" name="yearMonth" v-model="yearMonth"> {{dateFrom}} ~ {{dateTo}} </input>
        </div>
      </div>
      <div v-else-if="period === 'quarterly'">
        <div class="col-lg-6 col-sm-12">
          ...
          季別: <select v-model="selectedQuarter"> 
            <option v-for="quarter in 4" v-bind:value="quarter"> {{quarter}}</option>
          </select>
          {{dateFrom}} ~ {{dateTo}}
        </div>
      </div>
      ...
      <div v-else>
        <div class="col-lg-6 col-sm-12">
          <input type="date" v-model="selectedDateFrom"></input>
          -
          <input type="date" v-model="selectedDateTo"></input>
        </div>
      </div>
    </div>
    <div class="row center-block">
