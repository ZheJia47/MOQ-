...
<div class="layout-padding">
  ...
  <section class="content">
    ...
    <div id="ACC">
      ...
      <!--<q-td slot="body-cell-mondaySecond" slot-scope="props" :props="props">
      <span v-if="props.row.index>1" >
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </span>
      </q-td>
      <q-td slot="body-cell-mondayThird" slot-scope="props" :props="props">
      <span v-if="props.row.index>1" >
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      ...
      <q-td slot="body-cell-tuesdayFirst" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-tuesdaySecond" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-tuesdayThird" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-wednesdayFirst" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-wednesdaySecond" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-wednesdayThird" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-thursdayFirst" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-thursdaySecond" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-thursdayThird" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-fridayFirst" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-fridaySecond" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-fridayThird" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-saturdayFirst" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-saturdaySecond" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-saturdayThird" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-sundayFirst" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-sundaySecond" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>
      <q-td slot="body-cell-sundayThird" slot-scope="props" :props="props">
        <q-checkbox v-model="props.value"
          @blur="showInfor(props)"
        />
      </q-td>-->
...
export default {
  ...
  mounted () {
    getShiftNameArr(this.shiftKeys, this.$q.loading)
  },
  methods: {
    print () {
      window.print()
    ...
    showInfor (cellval, key) {
      ...
      // console.log(key)
      $.get('/api/updateShiftTable/' + this.rows2[cellval.row.__index].machineID + '/' + tgtdate + '/' + strArray[1].toLowerCase() + '/' + cellval.row[key], {}, (results) => {
...
function getShiftNameArr (shiftKeys, loading) {
  // init the records in the rows
  shiftKeys.splice(0, shiftKeys.length)
  shiftKeys.length = 0
  $.get('/api/shiftTimeConfig', {}, (results) => {
    if (results.type !== true) {
      ...
      results.data.forEach(elm => {
        shiftKeys.split(shiftKeys.length, 0, elm)
      })
    }
  })
}
