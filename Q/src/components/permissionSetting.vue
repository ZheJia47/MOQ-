  ...
  <section class="content">
   <div class="row inline bg-light-blue-7 full-width glossy">
    <div class="col-12 q-pl-xl text-white">
     ...
     <div class="col-6 q-pt-md q-mt-md q-pl-xs">
     <div class="col q-pl-md">
     <span>使用者帳號清單 - 權限設定</span>
     </div>
      <div class="row q-pl-md q-pt-md text-black">
     ...
     <q-btn outline glossy :label="availableTableShow?'返回':'展開'" @click="availableTableShow?backB():extendB()"/>
     ...
     <q-btn v-show="newRowVar" outline glossy label='取消' @click="newRowCancel(), newRowVar=false"/>
      ...
      <q-tr slot="body" slot-scope="props" :props="props">
        ...
        <q-td v-bind:key="col.name" v-else-if="col.name === 'select'" :props="props">
            ...
            <q-chip v-if="!props.row.selected" small square outline glossy @click="availableTableShow?noFunction():test(props)">確定</q-chip>
            <q-chip v-else small square color="dark" text-color="white" >確定</q-chip>
            <!--@click="availableTableShow?noFunction():testSel(props)"-->
          </q-td>
     ...
     <div class="col-6 q-mt-md">
      ...
      <div class="colum">
       <div class="col-4">
        ...
        <div v-show="availableTableShow" class="row justify-end q-pb-xs text-black">
